...
public class FoodProcessorScreen extends ContainerScreen<FoodProcessorContainer> {
    private final ResourceLocation GUI = new ResourceLocation(FoodOverflowMod.MODID,
            "textures/gui/food_processor_gui.png");

    public FoodProcessorScreen(FoodProcessorContainer p_i51105_1_, PlayerInventory p_i51105_2_, ITextComponent p_i51105_3_) {
