...
public enum FoodOverflowArmorMaterial implements IArmorMaterial {

    CARAMEL("caramel", 13, new int[]{1, 4, 5, 1}, 8,
    ...
    private FoodOverflowArmorMaterial(String name, int durabilityMultiplier, int[] slotProtections, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
    ...
    public String getName() {
        return FoodOverflowMod.MODID + ":" + this.name;
    }
